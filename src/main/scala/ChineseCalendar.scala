...
object ChineseCalendar {
  ...
  private val CEYears = Array(
    ...
    y(440, 2, 19, "庚寅 己未 己丑 戊午 戊子 丁巳 丁亥 丙辰 丙戌 丙辰 乙酉 乙卯"), 
    y(441, 2, 7,  "甲申 甲寅 癸未 癸丑 壬午 壬子 辛巳 辛亥 庚辰 庚戌 己卯 己酉"),
    y(442, 1, 27, "戊寅 戊申 戊寅 丁未 丁丑 閏 丙午 丙子 乙巳 乙亥 甲辰 甲戌 癸卯 癸酉"), 
    y(443, 2, 15, "壬寅 壬申 辛丑 辛未 辛丑 庚午 庚子 己巳 己亥 戊辰 戊戌 丁卯"),
    y(444, 2, 5,  "丁酉 丙寅 丙申 乙丑 乙未 甲子 甲午 癸亥 癸巳 癸亥 壬辰 壬戌"), 
  ...
  private val eraArray = Array(
    ...
    ("北魏太武帝延和", "", "", "", "", (CEYears, 432)),
    // TODO: remove "end", add comma at the end.
    ("北魏太武帝太延", "", "五年", "", "", (CEYears, 435))
    // TODO: calender difference starting from CE 445.
    // ("北魏太武帝太平真君", "六月", "", "", "", (CEYears, 440)),
    // ("北魏太武帝正平", "六月", "", "", "", (CEYears, 451)),
    // ("北魏南安王承平", "三月", "", "", "", (CEYears, 452)),
    // ("北魏文成帝興安", "十月", "", "", "", (CEYears, 452)),
    // ("北魏文成帝興光", "七月", "", "", "", (CEYears, 454)),
    // ("北魏文成帝太安", "六月", "", "", "", (CEYears, 455)),
    // ("北魏文成帝和平", "", "", "", "", (CEYears, 460)), 
    // ("北魏献文帝天安", "", "", "", "", (CEYears, 466)),
    // ("北魏献文帝皇興", "八月", "", "", "", (CEYears, 467)),
    // ("北魏孝文帝延興", "八月", "", "", "", (CEYears, 471)),
