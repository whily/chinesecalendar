...
object ChineseCalendar {
  ...
  private val eraList = List(
    ...
    // (List("漢武帝元朔", "元朔"), (BCEYears, -127)),
    // (List("漢武帝元狩", "元狩"), (BCEYears, -121)),
    // (List("漢武帝元鼎", "元鼎"), (BCEYears, -115)),
    // (List("漢武帝元封"), (BCEYears, -109)),
    // (List("漢武帝太初"), (BCEYears, -103)),
    (List("漢武帝天漢"), (BCEYears, -99)),
    (List("漢武帝太始"), (BCEYears, -95)),
    (List("漢武帝征和", "征和"), (BCEYears, -91)),
    (List("漢武帝後元", "後元"), (BCEYears, -87)),        
    (List("漢昭帝始元"), (BCEYears, -85)),
    (List("漢昭帝元鳳", "元鳳"), (BCEYears, -79)),
    (List("漢昭帝元平", "元平"), (BCEYears, -73)),        
    (List("漢宣帝本始", "本始"), (BCEYears, -72)),
    (List("漢宣帝地節", "地節"), (BCEYears, -68)),
    (List("漢宣帝元康"), (BCEYears, -64)),
    (List("漢宣帝神爵", "神爵"), (BCEYears, -60)),
    (List("漢宣帝五鳳"), (BCEYears, -56)),
    (List("漢宣帝甘露"), (BCEYears, -52)),        
    (List("漢宣帝黃龍"), (BCEYears, -48)),    
    (List("漢元帝初元", "初元"), (BCEYears, -47)),
    (List("漢元帝永光"), (BCEYears, -42)),
    (List("漢元帝建昭", "建昭"), (BCEYears, -37)),        
    (List("漢元帝竟寧", "竟寧"), (BCEYears, -32)),    
  ...
  /** Return the array of era names. If one era has both an long name
    * and short name (i.e. the short version is unique), only include
    * the short name. */
  def eraNames() = {
    eraMap.keys.toArray
  }
