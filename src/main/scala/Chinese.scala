...
object Chinese {
  ...
  private val CharacterTable = List(
    ...
    "卖賣", "麦麥", "门門", "黾黽", "难難", "鸟鳥", "聂聶", "宁寜", "农農", "齐齊",
    "岂豈", "气氣", "迁遷", "佥僉", "乔喬", "亲親", "穷窮", "区區", "啬嗇", "杀殺",
    "审審", "圣聖", "师師", "时時", "寿夀", "属屬", "双雙", "肃肅", "岁嵗", "孙孫",
    ...
    "坠墜", "迩邇", "弥彌瀰",       "祢禰", "玺壐", "猕獼", "泼潑", "废廢", "拨撥",
    "鏺", "沣灃", "艳艶", "滟灧", "讽諷", "沨渢", "岚嵐", "枫楓", "疯瘋", "飒颯",
    "砜碸", "飓颶", "飔颸", "飕颼", "飗飀", "飘飄", "飙飆", "刚剛", /*Check*/"掆", "岗崗",
    "纲綱", "棡", "钢鋼", "邝鄺", "圹壙", "扩擴", "犷獷", "纩纊", "旷曠", "矿礦",
    "岿巋", "阄鬮", "掴摑", "帼幗", "腘膕", "蝈蟈", "挝撾", "哗嘩", "骅驊", "烨燁",
    "桦樺", "晔曄", "铧鏵", "婳嫿", /*Check*/"擓","刽劊", "郐鄶", "侩儈", "浍澮", "荟薈",
    ...
    "钔鍆", "阂閡", "闺閨", "闻聞", "闼闥", "闽閩", "闾閭", "闿闓", /*Check*/"", "阁閣",
    "阀閥", "润潤", "涧澗", "悯憫", "阆閬", "阅閲", "阃閫", "阄鬮", "", "娴嫻",
    "阏閼", "阈閾", "阉閹", "阊閶", "阍閽", "阌閿", "阋鬩", "阐闡", "阎閻", "焖燜",
    "阑闌", "裥襇", "阔闊", "痫癇", "鹇鷳", "阕闋", "阒闃", "搁擱", "锏鐧", "锎鐦",
    "阙闕", "阖闔", "阗碴", "榈櫚", "简簡", "谰讕", "阚闞", "蔺藺", "澜瀾", "斓斕",
    /*Check*/"猖", "镧鑭", "躏躪", "渑澠", "绳繩", "鼋黿", "蝇蠅", "鼍鼉", "傩儺", "滩灘",
    "摊擹", "瘫癱", "凫鳬", "鸠鳩", "岛島", "茑蔦", "鸢鳶",
    "鸣鳴", "枭梟", "鸩鴆", "鸦鴉", /*Check*/"鳾", "鸥鷗", "鸨鴇", "鸧鶬", "窎窵", "莺鶯",
    "鸪鴣", "捣搗", "鸫鶇", "鸬鸕", "鸭鴨", "鸯鴦", "鸮鴞", "鸲鴝", "鸰鴒", "鸳鴛",
    "鸵鴕", "袅裊", "鸱鴟", "鸶鷥", "鸾鵉", /*Check*/"鵁", "鸿鴻", "鸷鷙", "鸸鴯", "鴷",
    "鸼鵃", "鸽鴿", "鸹鴰", "鸺鵂", "鸻鴴", "鹈鵜", "鹇鷳", "鹁鵓", "鹂鸝", "鹃鵑",
    "鹆鵒", "鹄鵠", "鹅鵝", "鹑鶉", "鹒鶊", /*Check*/"鶄", "鹉鵡", "鹊鵲", "鹋鶓", "鹌鵪",
    "鹏鵬", "鹐鵮", "鹚鷀", "鹕鶘", "鹖鶡", /*Check*/"鶪", "鹗鶚", "鹘鶻", "鹙鶖", "鹜鶩",
    "鹛鶥", "鹤鶴", "鹣鶼", "鹞鷂", "鹡鶺", /*Check*/"鷉", "鹧鷓", "鹥鷖", "鹦鸚", "鹨鷚",
    ...
    "细細", /*Check*/"紬", "绅紳", "织織", "绌絀", "终終", "绉縐", "绐紿", "哟喲", "绖絰",
    ...
    "钿鈿", "铎鐸", /*Check*/"鏺", "铃鈴", "铅鉛", "铂鉑", "铄鑠", "铆鉚", "铍鈹", "钶鈳",
    ...
    "镗鏜", /*Check*/"鐯", "镘鏝", "镩鑹", "镦鐓", /*Check*/"鐥", "镨鐠", "镧鑭", "镥鑥", "镤鏷",
    ...
    "脉脈", "猫貓", "栖棲", "弃棄", "升阩昇", "笋筍", "它牠", "席蓆", "凶兇", "绣繡",
